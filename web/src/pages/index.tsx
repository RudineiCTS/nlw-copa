  ...
  return (
    <div className='max-w-[1124px] h-screen  mx-auto grid grid-cols-2 gap-28 items-center'>
      <main>
        ...
        >Após criar seu bolão, você recebera um código único que poderá usar para convidar outras pessoas</p>
...
export const getServerSideProps = async()=>{
  const [poolCountResponse, guessCountResponse, userCountReponse] = await Promise.all([
    api.get('pools/count'),
  ...
  return {
    props:{
      ...
      userCount: userCountReponse.data.users
    }
  }
}
